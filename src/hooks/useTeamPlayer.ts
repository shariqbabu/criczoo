...
// Wrapped versions that return {data, loading} shape for pages
export function useTeamWithPlayers(id: string | undefined) {
  ...
  return {
    ...
    loading: teamQuery.isLoading || playersQuery.isLoading,
  };
}
